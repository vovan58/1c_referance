...
- Конференция
- Регламент регистрации названий разработчиков конфигураций
- Предоставление партнерам предварительных тестовых релизов конфигураций
- Передача в отдел технической поддержки информационных баз большого размера
- Презентационные материалы партнерских мероприятий
- Сервис публикации ошибок
- 
[База знаний 1С:Предприятие 8](https://developer.1c.ru/)
  или
...
[Инструменты разработчика и администратора](https://github.com/vovan58/1c_referance/blob/main/tools1%D1%81.md)

[С:Предприятие 8. Система стандартов и методик разработки конфигураций](https://its.1c.ru/db/v8std)

[Требования к программистам 1С](requirements_programmer1c.md)
